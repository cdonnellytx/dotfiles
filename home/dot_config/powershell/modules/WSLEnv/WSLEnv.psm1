...
function Get-WslEnvironment
{
    ...
    Get-DelimitedEnvironmentVariable @WSLEnvArgs @PSBoundParameters -SplitOptions ([StringSplitOptions]::RemoveEmptyEntries)
}
...
function Add-WSLEnvironment
{
    ...
    Add-ValueToDelimitedEnvironmentVariable @WSLEnvArgs -Target:$Target -Value:$Value -Prepend:$Prepend -Force:$Force -SplitOptions ([StringSplitOptions]::RemoveEmptyEntries)
}

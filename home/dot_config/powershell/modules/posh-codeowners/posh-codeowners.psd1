#
# Module manifest for module 'posh-codeowners'
#
...
FunctionsToExport = 'Get-CodeOwners', 'Read-CodeOwners', 'Get-CommonPath'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/cdonnellytx/posh-codeowners.git'

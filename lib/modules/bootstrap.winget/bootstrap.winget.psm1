...
#requires -module bootstrap.logging, bootstrap.os, bootstrap.parser, Microsoft.WinGet.Client
...
function Install-ViaWinGet
{
    ...
    (
        ...
        [Microsoft.WinGet.Client.PSObjects.PSPackageInstallMode] $Mode = [Microsoft.WinGet.Client.PSObjects.PSPackageInstallMode]::Silent,
        ...
        if (!$PSCmdlet.ShouldProcess($InputObject.ToString(), 'Install via WinGet'))
        {
            if ($PassThru)
            {
                ...
                return [PSCustomObject] @{
                    ...
                    ExtendedErrorCode = [Exception] $null
                    CorrelationData = ""
                }
            }
            return
...
function Lock-WinGet
{
    ...
    process
    {
        ...
        Get-WinGetPackage -MatchOption:Equals @GetParams | ForEach-Object {
